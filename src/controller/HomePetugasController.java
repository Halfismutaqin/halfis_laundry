...
import view.HomePetugasView;


public class HomePetugasController extends MouseAdapter implements ActionListener {
    HomePetugasView view;
    HomePetugasModel model;
    CariPelangganView cariPelangganView;
    Transaksi b;
    private String idPel;
    
    public HomePetugasController(String nama) {
        DateFormat dateFormat = new SimpleDateFormat("dd/MM/YYY");
        Date date = new Date();
        String tgl = dateFormat.format(date);
        view = new HomePetugasView();
        model = new HomePetugasModel();
        ...
        if (baris == -1 && view.getTfCari().equals("")) {
            ...
            if (baris != -1) {
                ...
                try {
                    ...
                    Logger.getLogger(HomePetugasController.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
        ...
        switch (idx) {
            case 0 : {
                if (searchBy.equals(""))
                    ...
                    ArrayList<Pelanggan> dafPelanggan = model.loadDataPelanggan(searchBy);
        ...
        if (source.equals(view.getBtnHitung())) {
            ...
            if (cek(b,idPel) != null) {
                if (view.getLabelIdCust().equals("null")) {
                    ...
                    Pelanggan c = new Pelanggan(nama,alamat,no,jenisKelamin,id);
                    model.insertCust(c);
                }
